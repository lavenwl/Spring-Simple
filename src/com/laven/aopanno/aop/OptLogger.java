...
import com.laven.aop.PropertiesUtil;
@Component("optLogger")
@Aspect
public class OptLogger {
	@Pointcut("within(com.laven.aopanno..*)")
	...
	public Object logger2(ProceedingJoinPoint pjp) throws Throwable{
		...
		PropertiesUtil.getInstance("com/laven/aopanno/opt.properties");
